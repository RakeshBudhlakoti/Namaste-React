...
const RestaurantCard = (props) => {
  ...
  const {cloudinaryImageId,name,areaName,cuisines,costForTwo,avgRating,totalRatingsString,sla} = resData?.info;
  
  return (
    <div className="card">
      <img className="cardImg" src={"https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/"+cloudinaryImageId} alt="Restaurant Image" />
      <div className="container">
        <h4>  <b>{name}</b></h4>
        <h5> {areaName} (Delivery in : {sla.slaString})</h5>
        <h5>{cuisines.join(", ")}</h5>
        <h5>{costForTwo}</h5>
        ...
        <div className="row">
          <div className="col-md-12">
            ...
            <div className="res-container">
              ...
              {
                data.resData.map((restaurant) => <RestaurantCard resData={restaurant} />
                )
              }
              </div>
